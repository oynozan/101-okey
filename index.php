                            ...
                            <div class="tables">
                                <div class="table">
                                    <div class="table-content">
                                        <button class="play-button-down">OYNA</button>
                                        <button class="play-button-top">OYNA</button>
                                        <div class="table-price">
                                            <span>750 <img src="images/coins.png"></span>
                                        </div>
                                ...
                                <div class="table">
                                    <div class="table-content">
                                        <button class="play-button-left">OYNA</button>
                                        <button class="play-button-top">OYNA</button>
                                        <div class="table-price">
                                            <span>750 <img src="images/coins.png"></span>
                                        </div>
                                ...
                                <div class="table">
                                    <div class="table-content">
                                        <button class="play-button-right">OYNA</button>
                                        <button class="play-button-down">OYNA</button>
                                        <div class="table-price">
                                            <span>512 <img src="images/coins.png"></span>
                                        </div>
                                        <div class="table-features">
                                            <h5>1EL</h5>
                                            <h5>YARDIMLI</h5>
                                ...
                                <div class="table">
                                    <div class="table-content">
                                        ...
                                        <button class="play-button-down">OYNA</button>
                                        <div class="table-price">
                                            <span>10000 <img src="images/coins.png"></span>
                                        </div>
                                        <div class="table-features">
                                            <h5>1EL</h5>
                                            <h5>YARDIMLI</h5>
                                ...
                                <div class="table">
                                    <div class="table-content">
                                        ...
                                        <button class="play-button-down">OYNA</button>
                                        <div class="table-price">
                                            <span>3332 <img src="images/coins.png"></span>
                                        </div>
                                        <div class="table-features">
                                            <h5>1EL</h5>
                                            <h5>YARDIMLI</h5>
                ...
                <div class="row chat">
                    <div class="col-12 chat-container">
                        ...
                        <div class="text-container">
                            ...
                            <img src="images/close.png" class="sistemden-cikis-yap">
                        </div>
                    </div>
                </div>
            </div>
